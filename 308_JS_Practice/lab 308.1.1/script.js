...
console.log(`The four numbers are valid: ${isValid}`);
...
// 2. First number greater than last
...
const isValid2 = isSum50 && isTwoOdd && !anyOver25 && isUnique;
console.log(`Valid (with anyOver25 variable): ${isValid2}`);